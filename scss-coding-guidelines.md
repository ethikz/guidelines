The following document outlines a reasonable style guide for CSS/SCSS development in all codebases. These guidelines strongly encourage the use of existing, common, sensible patterns.
